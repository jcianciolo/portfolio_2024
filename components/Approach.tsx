  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card title="Preparation and Strategy" icon={<AceternityIcon order="Phase One" />}
        ...
        <Card title="Progress and Development" icon={<AceternityIcon order="Phase Two" />}
        ...
        <Card title="Launch and Expansion" icon={<AceternityIcon order="Phase Three" />}
